...
//----------------------------------------------------------------------
  ...
  const int ANN_INT_MAX = 1000;
#else
  #include <climits>
  #include <cfloat>
  const double ANN_DBL_MAX = DBL_MAX;
  const int ANN_INT_MAX = INT_MAX;
#endif
...
typedef signed int ANNcoord;				// coordinate data type
typedef signed int ANNdist;				// distance data type
...
const ANNdist	ANN_DIST_INF = ANN_INT_MAX;
